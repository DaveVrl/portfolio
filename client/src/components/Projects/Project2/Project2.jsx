    ...
    return(
        <div className={style.containerProject}>
            ...
            <div className={style.containerSpan}>
                ...
                <p><span>REPOSITORY</span> <a href="https://github.com/DaveVrl/SPA-Pokemon" target="Pokémon SPA"> Ir al sitio</a></p>
            </div>
            ...
            <div className={style.container_infotechs}>
                ...
                <div className={style.container_front_techs}>
                    ...
                    <p className={style.p_dependencies}><span>Dependencias:</span> axios.
                    </p> 
                </div>
                ...
                <div className={style.container_back_techs}>
                    ...
                    <p className={style.p_dependencies}><span>Dependencias:</span> dotenv, axios, morgan, nodemon, pg.
                    </p>
                </div>     
            </div> {/*InfoTechs*/}
